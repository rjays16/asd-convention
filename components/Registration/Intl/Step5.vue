<template>
	<div id="step-5">
		<div class="container">
			<h1 class="dmsans-bold text-center">INTERNATIONAL ASD MEMBER</h1>
			<div class="inner-content">
				<div class="form-section dmsans-regular">
					<form ref="form">
						<div class="rows d-flex justify-content-between">
							<div class="col-sm-4 p-2">
								<el-input placeholder="Last Name *" v-model="$v.form.last_name.$model" />
						...
						<div class="col-sm-12 p-2" >
							...
							<el-input placeholder="Certificate Name *" v-model="$v.form.certificate_name.$model" @input="form.certificate_name = toUpper($event)" autofocus></el-input>
						...
						<div class="col-sm-12 p-2">
							<el-input placeholder="Email Address *" v-model="$v.form.email.$model" />
						</div>
						<div class="col-sm-12 p-2">
...
import { toUpper } from "~/components/Helper/functions.js"
    ...
    data() {
      	return {
            form: {
				...
				is_pds: this.$store.state.registration.is_pds, // intl asd member with email are considered as PDS member
				member_type: 1,
				scope: true,
				role: 3,
			},
