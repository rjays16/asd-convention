<template>
	<div id="step-7">
		<div class="container">
			<p class="capt dmsans-regular fs-12m"><b>Please review your registration details</b></p>
			<div class="inner-content dmsans-regular ">
				...
				<div class="container text-center mt-5 d-flex justify-content-evenly">
					<button  @click="proceedToIdeapay()" class="btn-blue-round btn-small mob">Proceed to Payment</button>
				</div>
			</div>
		</div>
	</div>
