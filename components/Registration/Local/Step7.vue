<template>
	<div id="step-7">
		<div class="container">
			<p class="capt dmsans-bold fs-15m "></p>
			<!-- <h1 class="dmsans-bold text-center text-wrap">LOCAL (PHILIPPINES) NON-ASD MEMBER </h1> -->
			<h1 class="dmsans-bold text-center text-wrap">LOCAL <span v-show="form.is_pds">PDS MEMBER,</span> NON-ASD MEMBER</h1>
				...
				<div class="form-section dmsans-regular">
					<form>
						...
						<div class="col-sm-12 p-2">
							...
							<el-input placeholder="JUAN A. DELA CRUZ II, MD, FPDS" v-model="$v.form.certificate_name.$model"></el-input>
